...
- Every command and number in the README was run against a live server before being written down, including a `known limitations` section — 91.2% coverage, and the suite fails rather than skips when Postgres is missing
